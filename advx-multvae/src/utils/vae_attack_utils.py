...
from global_config import EXP_SEED, ATK_MAX_EPOCHS
from src.utils.helper import json_dump, reproducible
from src.modules.polylinear import PolyLinear
from src.utils.helper import save_model, load_model
...
def attack_single(log_dir, run_name, pretrained_model, attacker_config, attacker_opt,
    ...
    layer_config = [pretrained_model.latent_size] + attacker_config["size"]
    ...
    for epoch in trange(n_epochs, desc='epochs'):
        ...
        if cur_bac >= best_bal_acc:
            ...
            save_model(attacker_model, writer_path, f"atk_model")
    ...
    load_model(attacker_model, writer_path, "atk_model")
    attacker_model.eval()
